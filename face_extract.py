...
def getParser():
    ...
    parser.add_argument(
        ...
        "--imageFolder",
        dest="imageFolder",
        help="img folder to parse and extract",
        type=str,
        required=True,
    )
    parser.add_argument(
        ...
        "--outputDir",
        dest="outputDir",
        help="output root dir, input folder will be keep at this dir and extract face in it, default .",
        type=str,
        default=".",
        required=False,
    )
    parser.add_argument(
        ...
        "--model",
        dest="model",
        help="face detect model, currently only retinaface, ssd, mtcnn , opencv and dlib and mediapipe need to pip install, defualt retinaface ",
        type=str,
        default="retinaface",
        required=False,
    )
    parser.add_argument(
        ...
        "--min_confidence",
        dest="min_confidence",
        help="min confidence to extract face, default 0.7",
        type=float,
        default=0.7,
        required=False,
    )
    parser.add_argument(
        ...
        "--expand_ratio",
        dest="expand_ratio",
        help="expand ratio to extract face, default 0.2",
        type=float,
        default=0.2,
        required=False,
    )
...
if __name__ == "__main__":
    ...
    pics = [
        i for i in os.listdir(IMG_PATH) if osp.isfile(abspath := osp.join(IMG_PATH, i))
    ]
            ...
            logList.append(
                {
                    ...
                    "status": "success",
                    "raw_w": rawImg_shape[0],
                    "raw_h": rawImg_shape[1],
                    "bbox_top": bbox[0],
                    "bbox_right": bbox[1],
                    "bbox_bottom": bbox[2],
                    "bbox_left": bbox[3],
